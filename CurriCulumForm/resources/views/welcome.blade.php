                ...
                <div class="card border-primary shadow-sm border-0">
                    ...
                    <div class="card-body ">
                        <form class="" method="post" autocomplete="off">
                            <input type="hidden" name="_token" value="W50kCrIwzP4s6GN8s8IxZdn8WCGVlNOoDs9QYlHh">
                            <div class="card bg-white mb-3 shadow-sm ">
                                <div class="card-header p-2   bg-light ">
                                    <div class="card-title font-weight-bold mb-0  float-left mt-1">Personal Information
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div class="row no-gutters">
                                        <div class="col-md-6">
                                            <div class="form-group row no-gutters">
                                                <div class="col-md-3">
                                                    <label class="font-weight-bold  text-right">First
                                                        Name:<small><sup><small><i
                                                                        class="text-danger fas fa-star"></i></small></sup>
                                                        </small>
                                                    </label>
                                                </div>
                                                <div class="col-md-8">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row no-gutters">
                                                <div class="col-md-3">
                                                    <label class="font-weight-bold  text-right">Email:<small><sup><small><i
                                                                        class="text-danger fas fa-star"></i></small></sup>
                                                        </small>
                                                    </label>
                                                </div>
                                                <div class="col-md-8">
                                                    <input type="email" required="" data-users="personal_info"
                                                        data-column="email" name="email"
                                                        class="form-control form-control-sm  required valid_email unique_email"
                        ...
                        <div class="row no-gutters">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row no-gutters">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" required="" name="mobile1[${companyId}]" maxlength="11" class="form-control form-control-sm required" id="mobile1" placeholder="Enter Mobile Number" value="">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row no-gutters">
                            <div class="col-md-6">
                                <div class="form-group row no-gutters">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" required="" name="project_name[${companyId}][${projectId}]" class="form-control form-control-sm required" id="project_name" placeholder="Enter Project Name" value="">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group row no-gutters">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" required="" name="project_role[${companyId}][${projectId}]" class="form-control form-control-sm required" id="project_role" placeholder="Enter Project Role" value="">
                                    </div>
                                </div>
                            </div>
                        </div>
